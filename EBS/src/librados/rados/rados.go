...
//librados op flag
const (
	RadosOpFlagExcl              = C.LIBRADOS_OP_FLAG_EXCL
	RadosOpFlagFailok            = C.LIBRADOS_OP_FLAG_FAILOK
	RadosOpFlagFadviseRandom     = C.LIBRADOS_OP_FLAG_FADVISE_RANDOM
	RadosOpFlagFadviseSequential = C.LIBRADOS_OP_FLAG_FADVISE_SEQUENTIAL
	RadosOpFlagFadviseWillneed   = C.LIBRADOS_OP_FLAG_FADVISE_WILLNEED
	RadosOpFlagFadviseDontNeed   = C.LIBRADOS_OP_FLAG_FADVISE_DONTNEED
	RadosOpFlagFadviseNocache    = C.LIBRADOS_OP_FLAG_FADVISE_NOCACHE
)
